  ...
  return (
    <section id="contribute" className="min-h-[200px] my-10 flex flex-col gap-5 justify-center items-center w-full">
      ...
      <div className="text-center space-y-4 mb-10">
        ...
        <p className="text-lg sm:text-center text-left px-5">Our project is all about fostering meaningful relationships and connections.<br /> We&apos;re excited to have you join us and contribute to our success.</p>
      </div>
      <Link href="/channels">
