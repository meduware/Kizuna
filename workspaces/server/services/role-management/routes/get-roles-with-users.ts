...
import { getRolesWithUsers } from "../controllers/get-roles-with-users";
 ...
 *   get:
 *     summary: Fetch all roles and their users
...
router.get("/role-management/get-roles-with-users", getRolesWithUsers);
